 ...
 * Chris Pimentel
 * 11/16/25
 * Handles functioning of big locked doors
 */

public class BigLockedDoor : MonoBehaviour
{
    ...
    private void OnTriggerStay(Collider other)
    {
        ...
        if (other.gameObject.GetComponent<PlayerInventory>())
        {
            ...
            if (other.gameObject.GetComponent<PlayerInventory>().HasBigKey() && other.GetComponent<PlayerInventory>().interacting)
            {
